class Sword:
    ...
    def slashing_blow(self):
        self.strength -= 10
        return (
            f"Нанесён рубящий удар мечом {self.name}. "
    ...
    def piercing_strike(self):
        self.strength -= 5
        return (
            f"Нанесён пронзающий удар мечом {self.name}. "
...
katana = Sword("Верный", 1.5, "хват двумя руками")
classic_sword = Sword("Дежурный", 1.2, "хват одной рукой")
